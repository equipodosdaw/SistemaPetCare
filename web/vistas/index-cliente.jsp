    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            <a href="#"><i class="fa fa-cart-arrow-down"></i> <span>Calendario</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-cart-arrow-down"></i>Mis Mascotas</a></li>
                                <li><a href="#"><i class="fa fa-tags"></i>MAscota 1</a></li>
                                <li><a href="#"><i class="fa fa-tags"></i>MAscota 2</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2023 <a href="#">PETCARE</a>.</strong> Todos los derechos reservados.
            </footer>
